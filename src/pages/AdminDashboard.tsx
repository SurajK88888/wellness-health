...
import { Shield, Users, Ban, CheckCircle, ChevronDown } from "lucide-react";
      ...
      <div className="pt-24 section-padding bg-background">
        <div className="container-wellness">
          ...
          >
            ...
            <h1 className="font-serif text-3xl md:text-5xl font-bold text-foreground">User Management</h1>
            <p className="mt-3 text-muted-foreground font-sans max-w-lg">
              Manage users, assign roles, and maintain platform integrity.
            </p>
          </motion.div>
